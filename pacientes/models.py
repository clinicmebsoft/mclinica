...
class HistoriaClinica(models.Model):
    ...
    higiene = models.CharField(max_length=10,blank=True, choices=HIGIENE, default='Buena')  # B=Buena R=Regular S=Supervisar
    numero_cepillados = models.IntegerField(blank=True,default=0)
    alimentacion = models.CharField(max_length=10, blank=True,choices=ALIMENTACION,default='Buena')  # B=Buena R=Regualar B=Buena
...
class HistoriaClinicaForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['id_paciente','originario', 'medico_particular', 'telefono_medico', 'motivo_cita', 'enfermedad_ultimo_anos',
